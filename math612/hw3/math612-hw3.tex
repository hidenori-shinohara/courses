...
\begin{exer}{(3.2.6)}
  ...
  \begin{center}
    \begin{tikzcd}[cells={nodes={minimum height=2em}}]
      H^2(\mathbb{C}P^1; \mathbb{Z}) \arrow[r, "i^{\ast}"]                       & H^2(\mathbb{C}P^n; \mathbb{Z}) \\
      H^2(\mathbb{C}P^1; \mathbb{Z}) \arrow[r, "i^{\ast}"] \arrow[u, "g^{\ast} = (\cdot d)"] & H^2(\mathbb{C}P^n; \mathbb{Z}) \arrow[u, "g^{\ast}"].
    \end{tikzcd}
  \end{center}
