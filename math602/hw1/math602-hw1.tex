...
\begin{exer}{1}
  \begin{itemize}
    ...
    \item
      It suffices to show that $V(I) = V(I(V(I)))$ for any ideal $I \subset k[x_1, \cdots, x_n]$.
      $I \subset I(V(I))$ because every function in $I$ vanishes in $V(I)$.
      Thus $V(I) \supset V(I(V(I)))$ by the argument above.
      Let $p \in V(I)$.
      Then every function in $I(V(I))$ vanishes at $p$.
      Thus $p \in V(I(V(I)))$.
  \end{itemize}
\end{exer}
