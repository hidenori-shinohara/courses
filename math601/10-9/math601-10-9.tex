...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item
      ...
      \todo[inline]{
        Actually, this doesn't seem to work because $\sqrt{2} \in \mathbb{Z}/(p)$ for some $p$.
        For instance, when $p = 7$, $x^2 - 2 = (x + 3)(x - 3)$.
        Thus $x - 3 + (x^2 - 2) \mapsto \sqrt{2} - 3 + (x^2 - 2) = 0 + (x^2 - 2) = 0$ since $3^2 \equiv 2 \pmod 7$.
        This implies that the kernel contains $(x - 3)$ which is strictly larger than $(x^2 - 2)$.
        Umm... How can I make this work?
      }
  \end{itemize}
\end{proof}
