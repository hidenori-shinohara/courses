...
\begin{proof}
  ...
  We will first assume that $p$ is an odd prime because Problem 20 does not specify what $p$ is, but the previous and next problem says $p$ is an odd prime.
  \todo[inline]{
    Does $p$ have to be an odd prime?
  }
