...
\begin{exer}{(Problem 22)}
  ...
  $(1 + (p))x^2 - (2 + (p))$ is not irreducible if and only if $(\overline{a}x + \overline{b}) \mid ((1 + (p))x^2 - (2 + (p)))$ for some $\overline{a} \ne 0, \overline{b} \in \mathbb{Z}/(p)$ because of the degree.
\end{exer}
