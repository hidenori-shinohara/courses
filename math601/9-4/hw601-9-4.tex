...
\begin{proof}
  \begin{itemize}
    \item
      ...
      Then $\mathbb{Z} * r = \mathbb{Z} * r'$.
      Since $0 * r = 0 + r = r \in \mathbb{Z} * r$, there must exist a $k \in \mathbb{Z}$ such that $k * r' = r$.
      Therefore, $k + r' = r$.
    ...
    \item
      ...
      \end{align*}
      Let $k = r - r'$.
      Since $r = 0 + r = 0 * r \in \mathbb{Z} * r$ and $r = k + r' = k * r' \in \mathbb{Z} * r'$, $(\mathbb{Z} * r) \cap (\mathbb{Z} * r') \ne \emptyset$.
      Since two equivalence classes are either disjoint or identical, this implies that $\mathbb{Z} * r = \mathbb{Z} * r'$.
      In other words, $r \sim r'$.
  \end{itemize}
  TODO
\end{proof}
