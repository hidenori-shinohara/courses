...
\begin{proof}
  ...
  The covering space consists of the cube in Figure \ref{fig:covering_mg} stacked in all directions (up, down, right, left, front and back), and translations in any directions correspond to deck transformations bijectively.
  Therefore, the deck transformation group is $\mathbb{Z}^3$.
