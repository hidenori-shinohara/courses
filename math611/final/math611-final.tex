...
\begin{exer}{(Problem 1(b))}
  ...
  \begin{align*}
    0 \rightarrow \tilde{H}_2(X) \xrightarrows{\alpha} &\tilde{H}_1(A \cap B) \xrightarrow{\beta} \tilde{H}_1(A) \oplus \tilde{H}_1(B) \xrightarrow{\gamma} \tilde{H}_1(X) \rightarrow 0.
  \end{align*}
