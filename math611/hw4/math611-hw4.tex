...
\begin{proof}
  ...
  Then this is an evenly covered neighborhood of the left edge, and let $\tilde{N}_{i + 1}$ be an open set in $\tilde{X}$ such that the restriction of $p$ is a homeomorphic.
  \todo[inline]{
    Explain this more.
    Why does this work?
  }
