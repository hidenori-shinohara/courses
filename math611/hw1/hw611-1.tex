...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item
      ...
      By Proposition 1.12, $\pi_1(X) = \pi_1(S^1) \times \pi_1(D^2)$ and $\pi_1(A) = \pi_1(S^1) \times \pi_1(S^1)$.
      This implies the existence of a injective group homomorphism $\phi$ from $\mathbb{Z} \times \mathbb{Z}$ into $\mathbb{Z} \times 0$.
      This is impossible because $\phi(1) = 0 = \phi(2)$.
